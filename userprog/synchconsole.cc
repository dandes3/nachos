...
static void readSeek(void* pass) //Created to essentially pass a void pointer to the console creation
{
    SynchConsole* synchConsole = (SynchConsole*) pass;
    synchConsole->ReadAvail();
}

static void writeSeek(void* pass) //Created to essentially pass a void pointer to the console creation
{
    SynchConsole* synchConsole = (SynchConsole*) pass;
...
{
    console = new Console(fileReader, fileWriter, readSeek, writeSeek, this); //Build new console, "this" is a passed location identifier
                                                                              // readSeek and writeSeek passed as void pointers passed to 
                                                                              // console creation 
